    ...
    <footer className="bg-white border-t border-[var(--color-line)]">
      <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 text-sm">
          ...
          <div>
            <div className="text-xs font-mono text-[var(--color-muted)] mb-3">채널</div>
            <ul className="space-y-1.5">
              <li>
                <a
        ...
        <div className="mt-12 pt-6 border-t border-[var(--color-line)] flex flex-col md:flex-row justify-between gap-3 text-xs text-[var(--color-muted)]">
          <div>© {new Date().getFullYear()} efface. All rights reserved.</div>
          <div className="flex gap-5">
            <a href="/privacy" className="hover:text-[var(--color-ink)]">개인정보처리방침</a>
            <a href="/terms" className="hover:text-[var(--color-ink)]">이용약관</a>
          </div>
        </div>
      </div>
    </footer>
